...
def main(season):
    ...
    for t in type:
        while True:
            driver.get(f'https://www.nba.com/stats/players/{t}/?SeasonType=Regular%20Season&SeasonYear={season}&PerMode=Totals&TypeGrouping=defensive')
            select_all(driver)
    ...
    for t in type:
        ...
        final_df[f'{t}_percentile'] = final_df[f'{t}_ppp'].rank(pct=True, ascending=False)
    ...
    final_df.to_csv(f'final_data/{season}/defense.csv', index=False)
